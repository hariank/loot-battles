...
contract SyntheticLoot {
  ...
  function chestComponents(address walletAddress)
    public
    view
    returns (uint256[5] memory)
  {
  ...
  function headComponents(address walletAddress)
    public
    view
    returns (uint256[5] memory)
  {
  ...
  function waistComponents(address walletAddress)
    public
    view
    returns (uint256[5] memory)
  {
  ...
  function footComponents(address walletAddress)
    public
    view
    returns (uint256[5] memory)
  {
  ...
  function handComponents(address walletAddress)
    public
    view
    returns (uint256[5] memory)
  {
  ...
  function neckComponents(address walletAddress)
    public
    view
    returns (uint256[5] memory)
  {
  ...
  function ringComponents(address walletAddress)
    public
    view
    returns (uint256[5] memory)
  {
  ...
  function pluckName(
    ...
    uint256 rand = random(
      string(abi.encodePacked(keyPrefix, abi.encodePacked(walletAddress)))
    );
